...
.step-circle.active {
    ...
    color: white;
    box-shadow: 0 4px 12px rgba(19,128,116,0.4);
}
...
<div class="step-container">
    <a href="javascript:window.location.href='streamlit_app.py'" class="nav-link">Back to Home</a>
    
    <div class="steps-tracker">
        <div class="step">
            <div class="step-circle active">1</div>
            <div class="step-label active">Deal Sourcing</div>
        </div>
        ...
        <div class="step">
            ...
            <div class="step-label inactive">Due Diligence</div>
        </div>
        ...
        <div class="step">
            ...
            <div class="step-label inactive">Market Analysis</div>
        </div>
        ...
        <div class="step">
            ...
            <div class="step-label inactive">Financial Model</div>
        </div>
        ...
        <div class="step">
            ...
            <div class="step-label inactive">Investment Memo</div>
        </div>
    </div>
    
    <div class="brand-text">Regulus AI</div>
</div>
""",
    unsafe_allow_html=True,
)
...
# ===== DEAL DISCOVERY EXECUTION (CENTERED TEAL BUTTON) =====
