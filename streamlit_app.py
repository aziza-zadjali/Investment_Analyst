...
With alternating section backgrounds like QDB website
"""
...
<div style='display:grid;grid-template-columns:1fr 2.5fr 1fr;align-items:center;padding:25px 0;border-bottom:3px solid {QDB_PURPLE};'>
    <div style='text-align:center;'>{"<img src='"+qdb_logo+"' style='max-height:90px;'>" if qdb_logo else "<strong>Qatar Development Bank</strong>"}</div>
...
with col1:
    st.markdown(f"""
    <div style='background:white;border-radius:12px;padding:35px;height:420px;box-shadow:0 5px 20px rgba(0,0,0,0.08);border-left:5px solid {QDB_PURPLE};transition:all 0.3s ease;display:flex;flex-direction:column;'>
...
# ===== SECTION 2: QUICK TOOLS (Dark Background) =====
qdb_section_start("dark")

st.markdown("<h2 style='text-align:center;margin-bottom:30px;'>Quick Access Tools</h2>", unsafe_allow_html=True)
